...
if __name__ == '__main__':
    ...
    initial_conditions = [jnp.array([.75, 0.])]
    time_horizon = (0, 0.45)
    noise_scalar = 0.01
    ...
    run_config = RunConfig(
        ...
        data_generation=DataGenerationConfig(
            scaling=Scaling(state_scaling=jnp.diag(jnp.array([1., 5 * 1e2])),
        ...
        interaction=InteractionConfig(
            ...
            measurement_collector=MeasurementCollectionConfig(
                ...
                noise_std=0.0,
                time_horizon=TimeHorizonConfig(type=TimeHorizonType.FIXED, init_horizon=0.45),
