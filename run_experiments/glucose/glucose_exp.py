...
def experiment(
    ...
    initial_conditions = [jnp.array([0.75, 0.0])]
    time_horizon = (0, 0.45)
    noise_scalar = 0.01
    ...
    run_config = RunConfig(
        ...
        data_generation=DataGenerationConfig(
            scaling=Scaling(
                state_scaling=jnp.diag(jnp.array([1.0, 5 * 1e2])),
            ...
            simulator_type=SimulatorType.GLUCOSE,
        ...
        comparator=ComparatorConfig(num_discrete_points=num_measurement_points),
    )
