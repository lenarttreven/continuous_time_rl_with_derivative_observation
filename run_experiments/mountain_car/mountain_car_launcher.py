...
PROJECT_NAME = "Mountain_car_edit_dimensions"
...
def main():
    ...
    for mss in applicable_configs['MSS']:
        for data_seed in applicable_configs['data_seed']:
            ...
            cmd = generate_base_command(mountain_car_exp, flags=flags)
            command_list.append(cmd)

    # submit jobs
    generate_run_commands(command_list, num_cpus=1, num_gpus=1, mode='euler', num_hours=23, promt=True, mem=16000)
