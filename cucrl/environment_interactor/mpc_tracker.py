...
class MPCTracker:
    ...
    def update_mpc(self, x_k, t_k_idx, tracking_data, mpc_params: MPCParameters,
        ...
        oc_trajectory = self.mpc_tracker.track_online(dynamics_model, x_k, mpc_params, tracking_data, t_k_idx)
        # Update true policy
    ...
    def true_policy_place_holder(self):
        ...
        return TruePolicy(ts_idx=jnp.zeros(num_indices, dtype=int),
