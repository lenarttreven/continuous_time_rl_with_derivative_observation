...
from cucrl.trajectory_optimization.numerical_computations.legendre_gauss_lobatto import (
    LegendreGaussLobatto,
)
from cucrl.trajectory_optimization.numerical_computations.local_point_splines import (
    LocalPointSplines,
)
from cucrl.trajectory_optimization.numerical_computations.local_splines import (
    LocalSplines,
)
...
def get_numerical_computation(
    numerical_computation: NumericalComputation, num_nodes, time_horizon
):
