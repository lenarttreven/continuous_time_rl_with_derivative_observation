...
class SAC:
    def __init__(self,
        ...
        # equals to
        self.num_training_steps_per_epoch = math.ceil((num_timesteps - num_prefill_env_steps) /
                                                      (self.num_evals_after_init * self.env_steps_per_actor_step))
    ...
    def training_step(self, training_state: TrainingState, env_state: envs.State, buffer_state: ReplayBufferState,
        ...
        training_state = training_state.replace(
            ...
            env_steps=training_state.env_steps + self.env_steps_per_actor_step)
