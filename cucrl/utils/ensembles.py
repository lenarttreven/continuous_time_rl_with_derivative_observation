...
class DeterministicEnsemble:
    ...
    def _nll(pred_raw: jax.Array, y_batch: jax.Array, data_std_batch: jax.Array):
        ...
        log_prob = norm.logpdf(
            y_batch[jnp.newaxis, :], loc=pred_raw, scale=data_std_batch[jnp.newaxis, :]
        )
        return -jnp.mean(log_prob)

    def _neg_log_posterior(
        self, pred_raw: jax.Array, y_batch: jax.Array, data_std_batch: jax.Array
    ):
    ...
    def calculate_calibration_alpha(
        self, params, stats, xs, ys, ys_stds, ps, data_stats: DataStatsBNN
    ) -> jax.Array:
    ...
    def _calibration_errors(
        self, params, stats, xs, ys, ys_stds, ps, data_stats: DataStatsBNN, alpha
    ) -> jax.Array:
