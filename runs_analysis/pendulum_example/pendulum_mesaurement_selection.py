...
def add_measurement_selection_on_plot_phase(fig, ax, measurement_selection: MeasurementSelection):
    ...
    ax.scatter(measurement_selection.potential_xs[:, 0][::repeat_num],
               ...
               color='blue', marker='+', s=300, linewidth=2, label='Equidistant MSS')
    ...
    ax.scatter(measurement_selection.potential_xs[proposed_indices, 0],
               ...
               color='green', marker='x', s=300, linewidth=2, label='Adaptive MSS')
...
def add_measurement_selection_on_plot(ax, measurement_selection: MeasurementSelection):
    ...
    ax.scatter(measurement_selection.proposed_ts.reshape(-1),
               ...
               color='green', marker='x', s=300, linewidth=3)
    ax.scatter(np.linspace(0, 10, 10),
               jnp.zeros_like(measurement_selection.proposed_ts.reshape(-1)),
               color='Blue', marker='+', s=300, linewidth=3)
